...
void TestUpscalePassUpscalesLowResolutionInputs()
{
    ...
    ctx.buffers.Add(Restir::kColorOutputName, sizeof(GfVec4f), static_cast<std::size_t>(srcWidth) * static_cast<std::size_t>(srcHeight));
    ctx.buffers.Add("Albedo", sizeof(GfVec3f), static_cast<std::size_t>(srcWidth) * static_cast<std::size_t>(srcHeight));
    ...
    const std::vector<GfVec3f> expectedAlbedo{
        GfVec3f(0.2f, 0.3f, 0.4f),
        GfVec3f(0.2f, 0.3f, 0.4f),
        GfVec3f(0.5f, 0.6f, 0.7f),
        GfVec3f(0.5f, 0.6f, 0.7f),
        GfVec3f(0.2f, 0.3f, 0.4f),
        GfVec3f(0.2f, 0.3f, 0.4f),
        GfVec3f(0.5f, 0.6f, 0.7f),
...
void TestPathTracerPipelinesMatch()
{
    ...
    Restir::SplitScreenCompositor compositor{
...
void TestOptionalOutputsWithoutFramebuffer()
{
    ...
    Restir::SplitScreenCompositor compositor{
        Restir::makePathTracerPipeline("LeftAlbedo", settings),
...
void TestOptionalDepthOutputWithoutColor()
{
    ...
    Restir::SplitScreenCompositor compositor{
        Restir::makePathTracerPipeline("LeftDepth", settings),
...
void TestUnsupportedOutputDoesNotCrash()
{
    ...
    Restir::SplitScreenCompositor compositor{
        Restir::makePathTracerPipeline("LeftUnsupported", settings),

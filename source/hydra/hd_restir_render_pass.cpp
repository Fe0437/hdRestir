...
[[nodiscard]] std::vector<Restir::AovBinding> MakeRendererAovBindings(
...
HdRestirRenderPass::HdRestirRenderPass(HdRenderIndex *index,
...
bool
HdRestirRenderPass::IsConverged() const
{
...
void
HdRestirRenderPass::_Execute(HdRenderPassStateSharedPtr const& renderPassState,

...
public:
    ...
    const VtVec3fArray& GetPoints() const override { return _points; }
    const GfMatrix4f& GetTransform() const override { return _transform; }
    bool IsVisible() const override { return _visible; }
    const VtVec3fArray& GetColors() const override { return _colors; }
    const VtVec2fArray& GetUVs() const override { return _uvs; }
    const VtVec3fArray& GetNormals() const override { return _normals; }
    
    const std::vector<Subset>& GetSubsets() const override { return _subsets; }
    const SdfPath& GetInstancerId() const override { return _instancerId; }
    const SdfPath& GetId() const override { return HdMesh::GetId(); }

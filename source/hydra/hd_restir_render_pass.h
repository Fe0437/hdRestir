...
{
  public:
    HdRestirRenderPass(HdRenderIndex *index, HdRprimCollection const &collection, HdRenderThread *renderThread,
                       Restir::Renderer *renderer, std::atomic<int> *sceneVersion);

...
{
  public:
    HdRestirRenderParam(Restir::Scene *scene, std::atomic<int> *sceneVersion)
        : _scene(scene), _sceneVersion(sceneVersion)
    {
    }

    template <typename EditFn> void EditScene(EditFn &&editFn)
    {

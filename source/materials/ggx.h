...
// Static overloads are also provided for callers that already hold a closure and prefer not to construct an instance.
struct GGXBsdf final : public IBSDF {
    ...
    [[nodiscard]] static GfVec3f Eval(
        const GfVec3f&     shadingNormal,
        const GfVec3f&     wo,
        const GfVec3f&     wi,
        const BSDFClosure& c) noexcept;

    [[nodiscard]] static float Pdf(
        const GfVec3f&     shadingNormal,
        const GfVec3f&     wo,
        const GfVec3f&     wi,
        const BSDFClosure& c) noexcept;

...
public:
    explicit UpscalePass(std::vector<std::string> outputNames = {})
        ...
        , _outputNames{std::move(outputNames)}
    {
    }
    ...
    [[nodiscard]] std::vector<std::string> Inputs() const override { return _outputNames; }
    [[nodiscard]] std::vector<std::string> Outputs() const override { return _outputNames; }

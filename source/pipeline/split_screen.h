...
namespace Restir
{
    ...
    {
      public:
        SplitScreenCompositor(std::unique_ptr<RenderPipeline> left, std::unique_ptr<RenderPipeline> right,
                              int leftResolutionLevel = 0, int rightResolutionLevel = 0, int leftTargetSamples = 32,
        ...
        static void debugBlit(gsl::span<GfVec4f> dst, gsl::span<const GfVec4f> srcL, gsl::span<const GfVec4f> srcR,
                              int width, int height, float splitT)
        {
      ...
      private:
        ...
        static void blit(gsl::span<GfVec4f> dst, gsl::span<const GfVec4f> srcL, gsl::span<const GfVec4f> srcR,
                         int width, int height, float splitT);
    };

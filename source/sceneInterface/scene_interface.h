...
namespace Restir
{
    ...
    class IScene
    {
      public:
        ...
        virtual void BuildRenderState(const SceneBuildRenderStateConfig &config, const IRenderJob &job) = 0;
        ...
        [[nodiscard]] virtual std::optional<HitRecord> IntersectScene(const GfVec3f &rayOrigin,

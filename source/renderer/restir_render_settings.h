...
#define HD_RESTIR_RENDER_SETTINGS_TOKENS                                                    \
    ...
    ((primaryPipeline,               "restir:primaryPipeline"))                            \
    ((splitScreenRightPipeline,      "restir:splitScreen:rightPipeline"))                  \
    ...
    ((resolutionLevel,          "restir:resolutionLevel"))                                  \
    /* --- Path tracing ---------------------------------------------------------- */      \
    ...
    ((renderIblBackground,      "restir:path:renderIblBackground"))                         \
    /* --- RIS ------------------------------------------------------------------- */      \
    ((risCandidateCount,        "restir:ris:candidateCount"))                               \
    /* --- Denoiser -------------------------------------------------------------- */      \
    ((enableDenoiser,           "restir:denoiser:enable"))                                  \
    ((enableFireflyFilter,      "restir:denoiser:fireflyFilter"))                           \
    ((enableChromaticityBlur,   "restir:denoiser:chromaticityBlur"))                        \
    /* --- Post-process ---------------------------------------------------------- */      \
    ((enableLensFlare,          "restir:postProcess:lensFlare"))                            \
    ((lensDistortion,           "restir:postProcess:lensDistortion"))                       \
    ((chromaticAberration,      "restir:postProcess:chromaticAberration"))                  \
    /* --- Camera ---------------------------------------------------------------- */      \
    ((enableDoF,                "restir:camera:depthOfField"))                              \
    ((focalLength,              "restir:camera:focalLength"))                               \
    ((fStop,                    "restir:camera:fStop"))                                     \
    ((focusDistance,            "restir:camera:focusDistance"))                             \
    ((bokehBlades,              "restir:camera:bokehBlades"))                               \
    ((enablePhysicalCamera,     "restir:camera:physicalExposure"))                          \
    ((iso,                      "restir:camera:iso"))                                       \
    ((shutterSpeed,             "restir:camera:shutterSpeed"))                              \
    /* --- Sky ------------------------------------------------------------------- */      \
    ((physicalSkyEnable,        "restir:sky:enable"))                                       \
    ((physicalSkyTime,          "restir:sky:timeOfDay"))                                    \
    /* --- Debug ----------------------------------------------------------------- */      \
...
#define HD_RESTIR_RENDER_SETTINGS_SPECS(SpecT)                                                                                       \
    SpecT{"Pipeline (0=PathTracer 1=PostProcess 2=RIS)",     HdRestirRenderSettingsTokens->pipelineIndex,                   VtValue(0),                                              true},  \
    SpecT{"Split Screen Right Pipeline (0/1/2)",             HdRestirRenderSettingsTokens->splitScreenRightPipelineIndex,   VtValue(1),                                              true},  \
    SpecT{"Primary Pipeline",                                HdRestirRenderSettingsTokens->primaryPipeline,                 VtValue(Restir::GetPathTracerPipelineToken()),            true},  \
    SpecT{"Enable Split Screen",                             HdRestirRenderSettingsTokens->enableSplitScreen,               VtValue(false),                                          false}, \
    SpecT{"Split Screen Right Pipeline",                     HdRestirRenderSettingsTokens->splitScreenRightPipeline,        VtValue(Restir::GetPathTracerPostProcessPipelineToken()), true},  \
    SpecT{"Target Sample Count (Left)",                      HdRestirRenderSettingsTokens->targetSampleCount,               VtValue(32),                                             false}, \
    SpecT{"Target Sample Count (Right)",                     HdRestirRenderSettingsTokens->splitScreenTargetSampleCount,    VtValue(32),                                             false}, \
    ...
    SpecT{"Enable Pre-Pass: Firefly Filter",                 HdRestirRenderSettingsTokens->enableFireflyFilter,        VtValue(true),                                           true},  \
    SpecT{"Enable Pre-Pass: Chromaticity Blur",              HdRestirRenderSettingsTokens->enableChromaticityBlur,     VtValue(true),                                           true},  \
    ...
    SpecT{"Enable Physical Camera Exposure",                 HdRestirRenderSettingsTokens->enablePhysicalCamera,       VtValue(false),                                          false}, \
    ...
    SpecT{"Debug Overlay (only working in Debug Mode build)", HdRestirRenderSettingsTokens->debugOverlay,              VtValue(false),                                          false}

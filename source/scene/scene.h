...
public:
    ...
    [[nodiscard]] std::recursive_mutex& GetSceneLock() override { return _sceneLock; }
    ...
    [[nodiscard]] bool Intersect(const GfVec3f& rayOrigin,
...
private:
    ...
    struct RenderState {
        ...
        std::unique_ptr<ImageTextureSamplerFactory> TextureSamplerFactory{std::make_unique<ImageTextureSamplerFactory>()};
    };

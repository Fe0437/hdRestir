...
namespace Restir
{
    ...
    std::optional<LightSample> PhysicalSky::SampleLight(const GfVec3f & /*hitPos*/, Rng & /*rng*/) const
    {
    ...
    Pdf PhysicalSky::EvalPdf(const GfVec3f & /*hitPos*/, const GfVec3f & /*dir*/, float /*dist*/,

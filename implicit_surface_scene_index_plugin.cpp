...
TF_DEFINE_PRIVATE_TOKENS(_tokens, ((sceneIndexPluginName, "HdRestir_ImplicitSurfaceSceneIndexPlugin")));
...
HdRestir_ImplicitSurfaceSceneIndexPlugin::_AppendSceneIndex(const HdSceneIndexBaseRefPtr      &inputScene,
                                                            const HdContainerDataSourceHandle &inputArgs)
{
    ...
    HdContainerDataSourceHandle const localInputArgs =
        HdRetainedContainerDataSource::New(HdPrimTypeTokens->sphere, toMeshSrc, HdPrimTypeTokens->cube, toMeshSrc,
